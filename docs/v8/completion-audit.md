...
| AC-21 | Daemon restart, login, reboot, service crash, sleep, and wake recover | Partial | atomic SIGINT/SIGTERM loop exit, active-operation drain without claiming queued work, normal socket/lease teardown, queue/state restore, directory-serialized stable interrupted-backup staging recovery, idempotent reconciliation, explicit 30-second launchd/systemd fatal-restart pacing, restart, and crash tests | Login, reboot, sleep/wake, and service-crash platform artifacts |
