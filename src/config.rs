...
pub use api::{
    LockfileDiff, apply_runtime_env, build_image_lock, default_env_file_name, find_service,
    init_config, load_config, load_config_with, load_lockfile_with, lockfile_diff,
...
pub use types::{
    Config, Driver, Kind, LockedImage, Lockfile, ServiceConfig, SwarmGit, SwarmTarget,
};
