...
/// Complete owned context for one asynchronous migration decision worker.
pub(crate) struct MigrationDecisionExecutionOptions {
    pub(crate) operation: QueuedMigrationDecision,
