...
use crate::control_plane::engine::{
    ContainerDiscovery, ContainerLifecycle, NetworkDiscovery, NetworkManager, VolumeDiscovery,
        ...
        + NetworkManager,
{
    ...
    delete_owned_installation_resources(engine, installation.installation_id(), schema_version)
        .await
        .map_err(|error| error.to_string())?;
