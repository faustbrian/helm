...
mod ipc_installation_deletion_status;
mod ipc_installation_lifecycle;
mod ipc_installation_volume_deletion;
mod ipc_log_chunk;
...
pub(crate) use ipc_installation_deletion_status::IpcInstallationDeletionStatus;
pub(crate) use ipc_installation_lifecycle::IpcInstallationLifecycle;
pub(crate) use ipc_installation_volume_deletion::IpcInstallationVolumeDeletion;
