...
/// Complete immutable context for one MongoDB migration execution.
pub(crate) struct MongoDbMigrationOperationsOptions<'operation> {
    ...
    pub(crate) target_administrator: &'operation CredentialRecord,
