...
/// Complete immutable binding for one accepted v7 RabbitMQ vhost migration.
pub(crate) struct V7RabbitMqMigrationProviderOptions<'operation> {
    pub(crate) accepted: &'operation AcceptedV7InventoryRecord,
    pub(crate) source: &'operation V7LogicalDataMigrationSource,
    pub(crate) source_credential: &'operation V7RabbitMqCredential,
    ...
    pub(crate) target_definition: &'operation RabbitMqProjectDefinition,
...
impl Debug for V7RabbitMqMigrationProviderOptions<'_> {
    fn fmt(&self, formatter: &mut Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("V7RabbitMqMigrationProviderOptions")
            ...
            .field("target_definition", &self.target_definition)
