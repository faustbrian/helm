...
/// Complete immutable binding for one accepted v7 MinIO bucket migration.
pub(crate) struct V7MinioMigrationProviderOptions<'operation> {
    pub(crate) accepted: &'operation AcceptedV7InventoryRecord,
    pub(crate) source: &'operation V7LogicalDataMigrationSource,
    pub(crate) source_credential: &'operation V7MinioCredential,
    ...
    pub(crate) target_definition: &'operation ObjectStoreProjectDefinition,
...
impl Debug for V7MinioMigrationProviderOptions<'_> {
    fn fmt(&self, formatter: &mut Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("V7MinioMigrationProviderOptions")
