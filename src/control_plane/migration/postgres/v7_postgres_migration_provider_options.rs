...
/// Complete immutable context for one recovery-first v7 PostgreSQL transition.
pub(crate) struct V7PostgresMigrationProviderOptions<'operation> {
    pub(crate) accepted: &'operation AcceptedV7InventoryRecord,
    pub(crate) source: &'operation V7LogicalDataMigrationSource,
    pub(crate) source_credential: &'operation V7PostgresCredential,
...
impl Debug for V7PostgresMigrationProviderOptions<'_> {
    fn fmt(&self, formatter: &mut Formatter<'_>) -> std::fmt::Result {
        formatter
            .debug_struct("V7PostgresMigrationProviderOptions")
