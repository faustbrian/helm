...
pub(crate) use v7::{
    ...
    V7MigrationAdapterPlan, V7MigrationAdapterSelectionOptions, V7MigrationExecutionPlanOptions,
    ...
    V7ProjectInventoryRequest, V7PublicFileArtifact, V7RouteInventory, V7RouteMigrationAdapter,
    V7RuntimeFeature, V7ServiceInventory, V7TrustMigrationAdapter, V7VolumeInventory,
