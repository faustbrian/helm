...
pub(crate) use v7::{
    ...
    V7MigrationAdapterSelectionOptions, V7MigrationAdapterTarget, V7MigrationExecutionError,
    ...
    V7ProjectInventory, V7ProjectInventoryOptions, V7ProjectInventoryRequest, V7PublicFileArtifact,
    V7RouteInventory, V7RouteMigrationAdapter, V7RuntimeFeature, V7ServiceInventory,
