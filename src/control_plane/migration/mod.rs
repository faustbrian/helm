...
pub(crate) use v7::{
    ...
    V7InventoryBlocker, V7MigrationAdapterExecutor, V7MigrationAdapterPlan,
    ...
    V7ProtectedGeneratedEnvironmentAdapterOptions, V7PublicFileArtifact, V7RecreatedServiceTarget,
