...
pub(crate) use v7::{
    ...
    V7VolumeInventory, V7VolumeSource, capture_v7_generated_environment_rollback,
    inventory_v7_host_artifacts, inventory_v7_project, read_v7_generated_environment_rollback,
};
