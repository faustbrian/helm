...
pub(crate) use v7::{
    ...
    V7MigrationAdapterExecutor, V7MigrationAdapterPlan, V7MigrationAdapterSelectionOptions,
    V7MigrationAdapterTarget, V7MigrationExecutionError, V7MigrationExecutionJournal,
