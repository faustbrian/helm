...
mod installation_volume_deletion;
...
mod prune_redis_logical_resource;
...
pub(crate) use installation_deletion_plan::InstallationDeletionPlan;
pub(crate) use installation_deletion_plan_options::InstallationDeletionPlanOptions;
pub(crate) use installation_volume_deletion::InstallationVolumeDeletion;
...
pub(crate) use prune_redis_logical_resource::prune_redis_logical_resource;
