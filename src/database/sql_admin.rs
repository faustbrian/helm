...
//!
//! Contains database sql admin logic used by Stackctl command workflows.
...
pub(crate) fn ensure_sql_command_success(
    output: &std::process::Output,
    failure_prefix: &str,
) -> Result<()> {
    common::ensure_command_success(output, failure_prefix)
}
