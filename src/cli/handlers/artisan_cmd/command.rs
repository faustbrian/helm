...
mod tests {
    ...
    #[test]
    fn resolve_artisan_tty_respects_test_no_tty_override() {
        assert!(!super::resolve_artisan_tty(false, true, false));
        assert!(super::resolve_artisan_tty(true, false, true));
        assert!(!super::resolve_artisan_tty(false, false, true));
        assert!(!super::resolve_artisan_tty(false, false, false));
    }
    ...
    fn resolve_artisan_tty_uses_effective_tty_default_path() {
        ...
        assert_eq!(
            ...
            super::resolve_artisan_tty(true, false, false)
        );
        assert_eq!(
            effective_tty(false, false),
            super::resolve_artisan_tty(false, false, false)
        );
    }
}
