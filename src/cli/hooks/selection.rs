...
pub(crate) fn run_hooks_for_selected_services<'a>(
...
mod tests {
    ...
    use super::{run_hooks_for_selected_services, run_hooks_for_up_selection};
    ...
    #[test]
    fn run_hooks_for_selected_services_returns_selected_service() {
        let cfg = config();
        let services = run_hooks_for_selected_services(
            &cfg,
            Some("app"),
            None,
            HookPhase::PostUp,
